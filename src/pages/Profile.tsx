    ...
    <>
      ...
      <div className="px-4 -mt-12">
        <div className="flex items-end justify-between">
          <div className="w-24 h-24 rounded-full bg-snap text-snap-foreground grid place-items-center font-bold text-3xl border-4 border-background">{profile?.display_name?.[0]?.toUpperCase() ?? "?"}</div>
